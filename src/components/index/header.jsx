...
const Header = (props) => {
    ...
    return (
        <div>
            <div className="container-fluid bg-secondary py-1 px-xl-5">
                <div className="row">
                        ...
                        <div className="d-inline-flex align-items-center">
                            <div className="btn-group">
                                ...
                                <div className="dropdown-menu dropdown-menu-right">
                                    <button className="dropdown-item" type="button"><NavLink to="login">Sign in</NavLink></button>
                                    <button className="dropdown-item" type="button"><NavLink to="register">Sign up</NavLink></button>
                                </div>
                            </div>
                            <div className="btn-group mx-2">
                                <button type="button" className="btn btn-sm btn-light dropdowntoggle" data-toggle="dropdown">USD</button>
                                <div className="dropdown-menu dropdown-menu-right">
                        ...
                        <nav className="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style={{ width: 'calc(100% - 30px)', zIndex: 999 }}>
                            <div className="navbar-nav w-100">
                                ...
                                {categories.map(category => (
                                    <a href="" className="nav-item nav-link" key={category._id}>
                        ...
                        <nav className="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                            ...
                            <div className="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                                <div className="navbar-nav mr-auto py-0">
                                    ...
                                    <NavLink to="/details" className="nav-item nav-link">Item Details</NavLink>
                                    <div className="nav-item dropdown">
                                        ...
                                        <div className="dropdown-menu bg-primary rounded-0 border-0 m-0">
                                            <NavLink style={{color: 'black'}} to="/cart" className="dropdown-item">Shopping Cart</NavLink>
                                            <NavLink style={{color: 'black'}} to="/checkout"className="dropdown-item">Checkout</NavLink>
                                        </div>
                                    </div>
