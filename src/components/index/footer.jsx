    ...
    <div className="row border-top mx-xl-5 py-4" style={{ borderColor: 'rgba(256, 256, 256, .1) !important' }}>
      <div className="col-md-6 px-xl-0">
        <p className="mb-md-0 text-center text-md-left text-secondary">
          <a className="text-primary" href="https://chukwuma-onyedika9.web.app" target='_blank'>Copyright</a> &copy;. All Rights Reserved. Designed
          by <a className="text-primary" href="https://chukwuma-onyedika9.web.app" target='_blank'>Chukwuma</a>  2023.
        </p>
      </div>
