                        ...
                        <div className="d-flex mb-4">
                            ...
                            <form>
                                ...
                                <div className="custom-control custom-radio custom-control-inline">
                                    ...
                                    <label className="custom-control-label" htmlFor="color-2">Black</label>
                                </div>
                                <div className="custom-control custom-radio custom-control-inline">
                                    <input type="radio" className="custom-control-input" id="color-3" name="color" />
                                    <label className="custom-control-label" htmlFor="color-3">Black</label>
                                </div>
                                <div className="custom-control custom-radio custom-control-inline">
                                ...
                                <div className="custom-control custom-radio custom-control-inline">
                                    ...
                                    <label className="custom-control-label" htmlFor="color-5">Black</label>
                                </div>
                            </form>
                        </div>
